...
BEGIN
    -- Insert the new supplier data into the Suppliers table
...
SELECT * FROM orders;
SELECT * from C##urbanfood_user.BUYERS;
SELECT * FROM products;
...
INSERT INTO C##urbanfood_user.buyers (name, email, password, address, contact)
VALUES (
    'John Doe',
    'john1@example.com',
    '$2y$10$eW5XK8bVGnLQwYiJkmuV9ObDZL51b/sT99nG4m7/O/XoeB65AQfD2', -- Hashed "password123"
    '123 Main St',
    '0771234567'
);
SELECT email, contact FROM C##urbanfood_user.buyers;
DESC orders;
