...
CREATE TABLE Customers (
    customer_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Auto-incrementing unique ID
    username VARCHAR2(50) NOT NULL UNIQUE,                           -- Unique username for login
    password VARCHAR2(50) NOT NULL,                                  -- Password for login (consider hashing for security)
    name VARCHAR2(100) NOT NULL,                                     -- Customer's full name
    address VARCHAR2(255),                                           -- Address (optional)
    contact_info VARCHAR2(100),                                      -- Contact details (e.g., phone or email)
